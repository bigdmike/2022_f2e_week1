<template>
  ...
  >
    ...
    <img
      data-ghost-right
      src="/2022_f2e_week1/img/character/ghost_orange.svg"
    ...
    <img
      data-ghost-top
      src="/2022_f2e_week1/img/character/ghost_blue.svg"
    ...
    >
      <img
        src="/2022_f2e_week1/img/character/ghost_purple.svg"
        class="mr-4 sm:mr-5 sm:w-32 w-14"
      />
      <img
        src="/2022_f2e_week1/img/character/ghost_red.svg"
        class="sm:w-32 w-14"
      />
    </div>
    <!-- GHOST -->
    <div
      class="relative z-10 w-full max-w-screen-md px-20 mx-auto sm:px-10 xl:px-0"
    >
      <div data-title>
        <img
          class="hidden w-full mb-8 md:block"
          src="/2022_f2e_week1/img/text/cover_title.png"
        />
        <img
          class="block w-full mb-8 md:hidden"
          src="/2022_f2e_week1/img/text/cover_title@sm.png"
        />
      </div>
      ...
      >
        ...
        <div class="flex items-start overflow-hidden text-white">
          <div class="mr-10 text-center" data-count_box>
            <p class="font-pixel">個人組</p>
            <p class="text-2xl font-black font-pixel">973</p>
          </div>
          <div class="text-center" data-count_box>
...
import { cover_section_animation } from '@/gsap/scroll/cover_section';
export default {
  name: 'MainCover',
  components: {
    MainTitleMarquee,
